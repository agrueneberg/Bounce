    ...
    validatePermissions = function (permissions) {
     ...
     // Validate operators.
        ...
        if (operatorsValid === false) {
            console.log(operators, "Operators invalid");
            return false;
        } else {
         // Validate link.
            if (permissions.hasOwnProperty("_links") === true && permissions._links.hasOwnProperty("inherit") === true && permissions._links.inherit.hasOwnProperty("href") === true && typeof permissions._links.inherit.href === "string") {
                console.log(permissions._links.inherit.href, operators, "Link found");
                return true;
            } else {
                console.log(operators, "Enough operators?", operators.length === 4);

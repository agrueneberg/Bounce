(function () {
    ...
    var errors, mongo, bcrypt, async, url, request, fs, isSystemCollection, isFilesCollection,
        createObjectId, getUserId, sanitizeDocument, parseResourceUri;
    ...
    module.exports = function (options) {
        ...
        updatePermissions = function (resourcePath, body, user, callback) {
            var resourceMatcher, collectionName, documentName;
         // Make it more difficult for users to accidentally destroy their permissions.
            if (!(body.hasOwnProperty("govern") === true && body.hasOwnProperty("read") === true && body.hasOwnProperty("write") === true && body.hasOwnProperty("add") === true) && !(body.hasOwnProperty("_links") === true && body._links.hasOwnProperty("inherit") === true && body._links.inherit.hasOwnProperty("href") === true && typeof body._links.inherit.href === "string")) {
                callback(new errors.BadRequest("All four operators have to be defined unless the resource inherits from somewhere."));
            } else {
                parseResourceUri(resourcePath, function (err, parsed) {
                    if (err !== null) {
                        callback(err);

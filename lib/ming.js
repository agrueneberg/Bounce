(function () {
    ...
    hasPermission = function (permission, resource, user) {
        return resource.ming[permission].some(function (authorizedUser) {
            return user._id.equals(authorizedUser);
        });
    };
                                ...
                                db.createCollection(collectionName, function (err) {
                                    if (err !== null) {
                                     ...
                                     // Create collection metadata.
                                        db.collection("ming.collections", function (err, metadataCollection) {

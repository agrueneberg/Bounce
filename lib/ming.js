                                        ...
                                        if (hasPermission("add", collectionMetadata, user) === false) {
                                            ...
                                            db.collection(collectionName, function (err, collection) {
                                                if (err !== null) {
                                                 ...
                                                 // Merge permissions.
                                                    if (body.hasOwnProperty("_permissions") === false) {
                                                        body._permissions = {};
                                                    }
                                                 // Inherit permissions if permissions are not explicitly defined.
                                                    if (body._permissions.hasOwnProperty("govern") === false) {
                                                        body._permissions.govern = "inherit";
                                                    }
                                                    if (body._permissions.hasOwnProperty("read") === false) {
                                                        body._permissions.read = "inherit";
                                                    }
                                                    if (body._permissions.hasOwnProperty("write") === false) {
                                                        body._permissions.write = "inherit";
                                                    }
                                    ...
                                    collectionsCollection.findOne({
                                        ...
                                        if (err !== null) {
                                            ...
                                            if (collectionMetadata === null) {
                                                ...
                                                if (hasPermission("govern", collectionMetadata, user) === false) {
                                                    callback(new errors.Forbidden());
                                                } else {
                                                        ...
                                                        db.collection(collectionName, function (err, collection) {
                                                            ...
                                                            if (err !== null) {
                                                                ...
                                                                collection.findOne({
                                                                    ...
                                                                    var documentMetadata, permissions;
                                                                    if (err !== null) {
                                                                        callback(err);
                                                                    } else {
                                                                        if (document === null) {
                                                                         ...
                                                                         // Permissions of files are stored in the metadata property.
                                                                            ...
                                                                            if (inheritsPermission("govern", documentMetadata) === true) {
                                                                                documentMetadata = collectionMetadata;
                                                                            }
                                                                            if (hasPermission("govern", documentMetadata, user) === false) {
                                                                                callback(new errors.Forbidden());
                                                                            } else {

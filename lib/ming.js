(function () {
    ...
    var errors, mongo, bcrypt, async, url, request, isSystemCollection, isFilesCollection,
                            ...
                            if (err !== null) {
                                ...
                                async.filter(documents, function (document, callback) {
                                    ...
                                    documents = documents.map(function (document) {
                                     ...
                                     // Do not expose _permissions of collection.
                                ...
                                db.collection("ming.collections", function (err, collection) {
                                    if (err !== null) {
                                        ...
                                        collection.insert({
                                            ...
                                            _permissions: {
                                                govern: createPermissionState(user, "all"),
                                                read: createPermissionState(user, "all"),
                                                write: createPermissionState(user, "all"),
                                                add: createPermissionState(user, true)
                                            }
                                ...
                                if (err !== null) {
                                    ...
                                    async.filter(documents, function (document, callback) {
                                     ...
                                     // Permissions of files are stored in the metadata property.
                                        ...
                                        documents = documents.map(function (document) {
                                         // Do not expose _permissions of document.
                                            if (isFilesCollection(collectionName) === true) {
                        ...
                        request({
                            ...
                            if (err !== null) {
                                ...
                                if (user === null) {
                                    ...
                                    hasPermission("govern", body, null, null, function (err, flag) {
                                        if (err !== null) {
                                            callback(err);
                                        } else {
                                            if (flag === false) {
        ...
        hasPermission = function (permission, permissions, creator, user, callback) {
            async.whilst(function () {
                ...
                if (err !== undefined) {
                    ...
                    if (permissions[permission].hasOwnProperty(getUserId(user)) === true && (permissions[permission][getUserId(user)] === "all" || permissions[permission][getUserId(user)] === true)) {
                        callback(null, true);
                    } else if (permissions[permission].hasOwnProperty(getUserId(user)) === true && (permissions[permission][getUserId(user)] === "self" && getUserId(user) === creator)) {
                        callback(null, true);
                    } else if (getUserId(user) !== "public" && permissions[permission].hasOwnProperty("authenticated") === true && permissions[permission]["authenticated"] === true) {
                        callback(null, true);
                    } else {
                        callback(null, false);
                    }
